...
namespace CodingChallenge.Controllers
{
    public class AddressesController : Controller
    {
        ...
        public AddressesController(CodingChallengeContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Address != null ? 
                          ...
                          Problem("Entity set 'CodingChallengeContext.Address'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'CodingChallengeContext.Address'  is null.");
            }
            var address = await _context.Address.FindAsync(id);
            if (address != null)
            {
